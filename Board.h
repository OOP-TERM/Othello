#ifndef _MNT_C_USERS_USER_OODLAB_TERM_PROJECT_OTHELLO_BOARD_H_
#define _MNT_C_USERS_USER_OODLAB_TERM_PROJECT_OTHELLO_BOARD_H_
#include <string>
#include <vector>
...
#endif  // _MNT_C_USERS_USER_OODLAB_TERM_PROJECT_OTHELLO_BOARD_H_
